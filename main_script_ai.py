        ...
        while i < len(users):           # цикл по всем пользователям
            ...
            if current_time >= next_request_time:
                try:
                    ...
                    luck_sends += 1
                except Exception as e: # в архив, если ошибка отправки от сервера тг = 403 bkb 400 (отписался или неизвестен вообще)
...
async def web_app(message):
    try:
        ...
        logger.error(f"Обработки полученных от miniapp данных - {e}")
